...
function generateHaiku(event) {
  ...
  let context = `You are a haïku expert. Your mission is to write a haïku in basic HTML, separating each line with a <br/>. Do not add a title. Sign the poem with "From the mind of the artificial" in <strong> at the bottom. Make sure to follow the user instructions`;
